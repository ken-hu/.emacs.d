...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; popup interface for jedi
   `(popup-face ((,class (:foreground ,fg1 :background ,bg3))))
   `(popup-scroll-bar-background-face ((,class (:foreground nil :background nil))))
   `(popup-scroll-bar-foreground-face ((,class (:foreground nil :background nil))))
   `(popup-summary-face ((,class (:foreground ,fg1 :background ,bg3))))
   `(popup-tip-face ((,class (:foreground ,warning :background ,bg3))))
   `(popup-menu-mouse-face ((,class (:foreground ,fg1 :background ,bg3))))
   ;; company
   `(company-echo-common ((,class (:foreground ,bg1 :background ,fg1))))
   `(company-preview ((,class (:background ,bg1 :foreground ,key2))))
   `(company-preview-common ((,class (:foreground ,bg2 :foreground ,fg3))))
   `(company-preview-search ((,class (:foreground ,type :background ,bg1))))
   `(company-scrollbar-bg ((,class (:background ,nil))))
   `(company-scrollbar-fg ((,class (:foreground ,nil))))
   ...
   `(magit-diff-context-highlight ((,class (:background ,bg1 :foreground ,fg1))))
   `(magit-diff-file-header ((,class (:foreground ,fg2 :background ,bg3))))
   `(magit-diffstat-added   ((,class (:foreground ,type))))
   `(magit-diffstat-removed ((,class (:foreground ,var))))
   `(magit-hash ((,class (:foreground ,fg2))))
   `(magit-hunk-heading           ((,class (:background ,bg1))))
   `(magit-hunk-heading-highlight ((,class (:background ,bg1))))
   `(magit-item-highlight ((,class :background ,bg1)))
   ...
   `(magit-diff-added   ((,class (:foreground ,keyword))))
   `(magit-diff-removed ((,class (:foreground ,rainbow-9))))
   `(magit-diff-hunk-header ((,class (:foreground ,fg1 :background ,bg1))))
   `(magit-diff-hunk-heading ((,class (:foreground ,comment :background ,bg1))))
   `(magit-diff-hunk-heading-highlight ((,class (:foreground ,comment :background ,bg5))))
   ;; mode-line
   ...
   `(org-block ((,class (:foreground ,rainbow-5)))) ;; No effects for some reason
   `(org-block-background ((,class (:background ,bg2 :font ,"consolas-14"))))
   ;;`(org-code ((,class (:foreground ,rainbow-7))))
   `(org-code ((,class (:font ,"consolas-14"))))
